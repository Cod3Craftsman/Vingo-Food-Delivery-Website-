    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4" style={{ backgroundColor: bgColor }}>
      <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border`} style={{ border: `1px solid ${primaryColor}` }}>
        ...
        <div className="mb-4">
          ...
          <input type="email" className="w-full border rounded-lg px-3 py-2 focus:outline-none" required placeholder="Enter your Email" style={{ border: `1px solid ${borderColor}` }} value={email} onChange={(e) => setEmail(e.target.value)} />
        ...
        <button className={`w-full font-bold py-2 rounded-lg transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer`} onClick={handleSignIn} disabled={loading}>
          {
