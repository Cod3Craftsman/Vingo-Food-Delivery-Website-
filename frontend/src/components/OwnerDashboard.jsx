        ...
        <div className="flex justify-center items-center p-4 sm:p-6">
          <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-bold to-gray-800 mb-2">Add your Restaurant</h2>
              <p className="text-gray-600 mb-4 text-sm sm:text-base">Join our food delivery platform and connect with thousands of customers looking for great meals every day.</p>
          ...
          {myShopData.items.length == 0 &&
            <div className="flex justify-center items-center p-4 sm:p-6">
              <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col items-center text-center">
                  <FaUtensils className="text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4" />
                  <h2 className="text-xl sm:text-2xl font-bold to-gray-800 mb-2">Start Adding Your Dishes</h2>
                  <p className="text-gray-600 mb-4 text-sm sm:text-base">Showcase your best meals and reach hungry customers searching
                    for delicious food near them.</p>
